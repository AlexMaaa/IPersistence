...
public class DefaultSqlSession implements SqlSession {
    ...
    public Integer update(String statementid, Object... params) throws Exception {
        ...
        MappedStatement mappedStatement = configuration.getMappedStatementMap().get(statementid);
       return simpleExecutor.cud(configuration, mappedStatement, params);
    }
    ...
    @Override
    public <T> T getMapperUpdate(Class<?> mapperClass) {
        // 使用JDK动态代理来为Dao接口生成代理对象，并返回
    ...
    @Override
    public <T> T getMapperInsert(Class<?> mapperClass) {
        // 使用JDK动态代理来为Dao接口生成代理对象，并返回
    ...
    @Override
    public <T> T getMapperDelete(Class<?> mapperClass) {
        // 使用JDK动态代理来为Dao接口生成代理对象，并返回
